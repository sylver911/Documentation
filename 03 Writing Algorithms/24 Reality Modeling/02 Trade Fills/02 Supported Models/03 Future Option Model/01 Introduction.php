...
<pre class="csharp">// Fill future option trades immediately with FutureOptionFillModel.
security.SetFillModel(new FutureOptionFillModel());</pre>
<pre class="python"># ill future option trades immediately with FutureOptionFillModel.
security.set_fill_model(FutureOptionFillModel())</pre>
</div>
