...
<pre class="csharp">// Fill future trades immediately with FutureFillModel.
security.SetFillModel(new FutureFillModel());</pre>
<pre class="python"># Fill future trades immediately with FutureFillModel.
security.set_fill_model(FutureFillModel())</pre>
</div>
