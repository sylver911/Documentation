...
<pre class="csharp">// Fill equity trades completely and immediately.
security.SetFillModel(new EquityFillModel());</pre>
<pre class="python"># Fill equity trades completely and immediately.
security.set_fill_model(EquityFillModel())</pre>
</div>
